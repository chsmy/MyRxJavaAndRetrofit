...
public class RxRetrofit {
    ...
    public RxRetrofit(String URL, Map<String, Object> params, RequestBody BODY, File FILE, Context CONTEXT) {
        this.URL = URL;
    ...
    public static RxRetrofitBuilder builder(){
        return new RxRetrofitBuilder();
    }
